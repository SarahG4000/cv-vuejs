<template>
    <div class="container">
        ...
        <div class="box box-carousel columns is-mobile sg-cont">
                    ...
                    <CarouselSlide>
                        <div class="box box-carousel sg-box">
                            ...
                            <div class="columns">
                                ...
                                <div class="column">
                                    <form
                                        action="mailto:sarah.guillaume4000@gmail.com?subject=Commande design"
                                        name="envoi"
                                        method="POST"
                                        enctype="text/plain"
                                    >
...
.box {
    background-color: rgb(246, 236, 236) !important;
}
