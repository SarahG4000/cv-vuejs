    ...
    <div class="container is-mobile">
        ...
        <div class="box box-sg columns is-mobile">
            <div class="box box-sg column is-one-quarter">
                <h1 class="sg title is-family-primary">{{bundler}}</h1>
                    ...
                    <CarouselSlide>
                        <div class="box box-sg">
                            ...
                            <div class="columns">
                                ...
                                <p class="column is-two-thirds sg-top">sarah.guillaume4000@gmail.com</p>
                            </div>
                            <div class="columns">
                                <div class="column sg-padding">
                                    <span class="is-size-1">
                                ...
                                <p class="column is-two-thirds sg-top">SarahG#4150</p>
                            </div>
                        </div>
                    </CarouselSlide>
                    <CarouselSlide>
