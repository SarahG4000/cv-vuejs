                                ...
                                <div class="columns">
                                    <div class="column is-one-quarter margin-sg sg-grand">
                                        ...
                                        <div class="level-left">
                                            <span>
                                                <i class="fab fa-css3-alt i-sg"></i>
                                            </span>
                                            <p>CSS3</p>
                                        </div>
                                        <div class="level-right">
                                            <span>
                                                <i class="fab fa-git i-sg"></i>
                                            </span>
                                            <p>Git</p>
                                        </div>
                                        <div class="level-left">
                                            <span>
                                                <i class="fab fa-html5 i-sg"></i>
                                            </span>
                                            <p>HTML5</p>
                                        </div>
                                        <div class="level-right">
                                            <span>
                                                <i class="fab fa-js i-sg"></i>
                                            </span>
                                            <p>JavaScript</p>
                                        </div>
                                        <div class="level-left">
                                            <span>
                                                <i class="fab fa-node i-sg"></i>
                                            </span>
                                            <p>nodejs</p>
                                        </div>
                                        <div class="level-right">
                                            <span>
                                                <i class="fab fa-react i-sg"></i>
                                            </span>
                                            <p>Reactjs</p>
                                        </div>
                                        <div class="level-left">
                                            <span>
                                                <i class="fab fa-php i-sg"></i>
                                            </span>
                                            <p>Php</p>
                                        </div>
                                        <div class="level-right">
                                            <span>
                                                <i class="fab fa-wordpress i-sg"></i>
                                            </span>
                                            <p>Wordpress</p>
                                        </div>
                                    </div>
