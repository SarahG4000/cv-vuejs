                        ...
                        <div class="box box-sg">
                            ...
                            <div class="columns">
                                <div class="column">
                                    <p class>
                                        <span class="icon">
                                            <i class="fab fa-facebook-square is-size-2"></i>
                                        </span>
                                    </p>
                                </div>
                                <a
                            ...
                            <div class="columns">
                                ...
                                <a class="column is-two-thirds">https://github.com/SarahG4000</a>
                            </div>
                            <div class="columns">
                                <div class="column">
                                    <p class="is-size-3">
                            ...
                            <div class="columns">
                                ...
                                <a class="column is-two-thirds">sarah.guillaume4000@gmail.com</a>
                            </div>
                            <div class="columns">
                                <div class="column">
                                    <p class="is-size-3">
                                ...
                                <a class="column is-two-thirds">SarahG#4150</a>
                            </div>
                        </div>
                    </CarouselSlide>
                    <CarouselSlide>
